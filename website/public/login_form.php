...
<body class="bg-muted">
    <div class="container text-center mb-5">
        <div class="col-12 rounded-4 mt-5" id="centro">
            <img id="uniLogo" class="col-6 rounded-top" src="../img/uni_eibar.png" alt="uni-eibar logo">
            <form id="loginForm" name="loginForm" class="m-auto col-6 rounded-bottom p-4 text-light" method="POST"
                action="../modules/loginAction.php">
                <h2 class="pt-5 text-decoration-underline">Uni-Eibar canteen system</h2>
                <h4>Log in</h4>
                ...
                <div class="btn btn-primary mt-3">
                    <a role="button" href="signup_form.html">Sign up</a>
                </div>
            </form>
        </div>
    </div>
