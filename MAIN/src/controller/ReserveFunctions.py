...
def writeUserToFile(user):
    ...
    file_path = os.path.join(dir_path, "../../files/Users.pkl")
...
def writeMenuToFile(menu):
    dir_path = os.path.dirname(os.path.realpath(__file__))
    file_path = os.path.join(dir_path, "../../files/Menus.pkl")

    with open(file_path, "ab") as f:
        pickle.dump(menu, f, pickle.HIGHEST_PROTOCOL)


def writeReserveToFile(reserve):
    dir_path = os.path.dirname(os.path.realpath(__file__))
    file_path = os.path.join(dir_path, "../../files/Reserves.pkl")

    with open(file_path, "ab") as f:
        pickle.dump(reserve, f, pickle.HIGHEST_PROTOCOL)
...
def readReserves():
    ...
    with open(file_path, 'rb') as f:
        try:
            while True:
                reserve = pickle.load(f)
                print(f"User ID: {reserve.id_user}, Menu ID: {reserve.id_menu}, Date: {reserve.date}")
        except EOFError:
            pass
